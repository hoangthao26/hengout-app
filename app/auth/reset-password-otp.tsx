...
export default function ResetPasswordOTPScreen() {
    ...
    const handleOtpComplete = (value: string) => {
        ...
        if (value.length === 6 && !hasAutoSubmitted && !loading) {
            ...
            setTimeout(() => {
                handleVerifyOTPWithValue(value);
            }, 100);
        }
    ...
    const handleVerifyOTPWithValue = async (otpValue: string) => {
        ...
        try {
            ...
            // Navigate to reset password screen with secure navigation
    ...
    const handleResendOTP = async () => {
        ...
        try {
            ...
            if (response.data.sessionToken) {
                // Update the session token in the URL params
                router.setParams({
                        ...
                        <View style={{ alignItems: 'center' }}>
                            ...
                            >
                                <Text style={{
                                    ...
                                    {resendLoading ? t('sending') : !canResend ? `${t('resend')} ${resendCountdown}s` : t('resend_otp')}
                                </Text>
                            </TouchableOpacity>
                        </View>
                    </View>
